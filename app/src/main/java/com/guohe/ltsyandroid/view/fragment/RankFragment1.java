...
import com.guohe.ltsyandroid.view.adapter.AuthorListAdapter;
...
public class RankFragment1 extends BaseFragment {
    ...
    protected void initView(View view) {
        refreshView(R.id.rank_fragment1_refresh, new SwipeRefreshLayout.OnRefreshListener() {
            @Override
    ...
    private void bindView() {
        ...
        mAdapter = new AuthorListAdapter(this.getContext());
        ...
        space.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
                DensityUtil.dip2px(this.getActivity(), 2)));
