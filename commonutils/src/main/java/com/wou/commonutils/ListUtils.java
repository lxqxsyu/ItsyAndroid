...
public class ListUtils {
    ...
    public static List<String> getListUrls(String picurls) {
        List<String> picStrs = NStringTools.nSplit(picurls, "{$}");
        if (picStrs == null) {
            return null;
        }
        return picStrs;
    ...
    public static List<String> getListUrls(String picurls, String addStr) {
        List<String> picStrs = NStringTools.nSplit(picurls, "{$}");
        if (picStrs != null) {
            List<String> list = new ArrayList<String>();
            for (int i = 0; i < picStrs.size(); i++) {
                list.add(addStr + picStrs.get(i));
            }
            return list;
        } else {
            return null;
    ...
    public static List<String> getListUrlsCortainSpac(String picurls) {
        List<String> picStrs = NStringTools.splitSpace(picurls, "{$}");
        if (picStrs == null) {
            return null;
        }
        return picStrs;
