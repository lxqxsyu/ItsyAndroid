...
//            bundle.putBoolean(ConstantString.DATA_IS_SIAMLL_PIC, isSmallPic);
//            bundle.putString(ConstantString.DATA_FILE_PATH, newFile.getAbsolutePath());
//            loadFinishCallBack.loadFinish(bundle);
//        } else {
////            ToastUtils.showShortMessage(ConstantString.SAVE_FAILED);
//            Toast.makeText(activity,ConstantString.SAVE_FAILED,Toast.LENGTH_SHORT).show();
//
//        }
//
//    }
